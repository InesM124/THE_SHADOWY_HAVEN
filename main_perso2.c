...
blitminimap (&mini,screen,choix);
            ...
            if(event.key.keysym.sym==SDLK_ESCAPE)
	    {
            ...
            else if(event.key.keysym.sym==SDLK_d)//deplacement a droite du perso1
            {
                c.directionhero=1;
                choix=1;
...
blitminimap (&mini,screen,choix);
            ...
            else if(event.key.keysym.sym==SDLK_q)//deplacement a gauche du perso1
            {
                c.directionhero=2;
                choix=2;
                p--;
...
blitminimap (&mini,screen,choix);
  ...
  break;
        ...
        if (keystate[SDLK_d] && keystate[SDLK_s])//deplacement a droite avec acceleration perso1
        {
            c.directionhero=1;
            choix=1;
            SDL_BlitSurface(back,&camera,screen,&pos_back);
...
blitminimap (&mini,screen,choix);
        ...
        else if (keystate[SDLK_q] && keystate[SDLK_s])//deplacement a gauche avec acceleration perso1
        {
            c.directionhero=2;
            choix=2;
            SDL_BlitSurface(back,&camera,screen,&pos_back);
