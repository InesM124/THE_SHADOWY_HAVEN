...
int main_perso(SDL_Surface *screen,hero c, hero d)
{
	...
	int colob_enemy2,colob_enemy3,colob_enemy4,colob_enemy5,colob2_enemy1,colob2_enemy2,colob2_enemy3,colob2_enemy4,p=0,p2=0;
...
blitminimap (&mini,screen,choix);
         ...
         /*colen2=collision_bb(&d,&enemy4);
          if(colen2==1)
          {//printf("collision between monster and hero2\n");
            d.vie.valVie--;
           gameOver=nbVie(gameOver,d.vie,screen);
           }*/
...
blitminimap (&mini,screen,choix);
	  ...
	  /*colen2=collision_bb(&d,&enemy3);
        ...
        colob2_enemy3=coll_bb3(&obstacle3,camera);
          if(colob2_enemy3==1)
          {//printf("collision between hero2 and obstacle\n");
           //while (s1>0)
            s1-=10;
...
blitminimap (&mini,screen,choix);
	  ...
	  /*colen2=collision_bb(&d,&enemy2);
        ...
        colob2_enemy2=coll_bb2(&obstacle2,camera);
          if(colob2_enemy2==1)
          {//printf("collision between hero2 and obstacle\n");
           //while (s1>0)
            s1-=10;
...
blitminimap (&mini,screen,choix);
	  ...
	  /*colen2=collision_bb(&d,&enemy1);
        ...
        colob2_enemy1=coll_bb1(&obstacle1,camera);
          if(colob2_enemy1==1)
          {//printf("collision between hero2 and obstacle\n");
           //while (s1>0)
            s1-=10;
...
blitminimap (&mini,screen,choix);
	  ...
	  /*colen2=collision_bb(&d,&enemy);
        ...
        colob2=coll_bb(&obstacle,camera);
          if(colob2==1)
          {//printf("collision between hero2 and obstacle\n");
           //while (s1>0)
            s1-=10;
...
blitminimap (&mini,screen,choix);
            ...
            else if(event.key.keysym.sym==SDLK_d)//deplacement a droite du perso2
            {
                d.directionhero=1;
                choix1=1;
                gameOver1=nbVie(gameOver1,d.vie,screen);
...
blitminimap (&mini,screen,choix);
            ...
            else if(event.key.keysym.sym==SDLK_q)//deplacement a gauche du perso2
            {
                d.directionhero=2;
                choix1=2;
...
blitminimap (&mini,screen,choix);
            ...
            {
                jump(&d,screen,pos_back,back,d.directionhero,&s1,camera);
...
blitminimap (&mini,screen,choix);
            ...
            {
                restartjump(&d,screen,pos_back,back,d.directionhero,camera);
                blithero(&c,screen,choix);
                c.score.posFond.y=-25;
                d.score.posFond.y=-25;
                afficherScore(screen,&c.score,s);
...
blitminimap (&mini,screen,choix);
        ...
        if (keystate[SDLK_d] && keystate[SDLK_p])//deplacement a droite avec acceleration perso2
        {
            d.directionhero=1;
            choix1=1;
            SDL_BlitSurface(back,&camera,screen,&pos_back);
            deplacerhero_avec_acceleration(&d);
            blithero(&d,screen,choix1);
            blithero(&c,screen,choix);
            if(k1<d.pos_hero.x)
            {
...
blitminimap (&mini,screen,choix);
        ...
        else if (keystate[SDLK_q] && keystate[SDLK_p])//deplacement a gauche avec acceleration perso2
        {
            d.directionhero=2;
            choix1=2;
            SDL_BlitSurface(back,&camera,screen,&pos_back);
...
blitminimap (&mini,screen,choix);
    ...
    SDL_FreeSurface(d.spriteright);
    SDL_FreeSurface(d.spriteleft);
    SDL_FreeSurface(back);
    SDL_FreeSurface(c.vie.vie1);
    SDL_FreeSurface(c.vie.vie2);
    SDL_FreeSurface(c.vie.vie3);
    SDL_FreeSurface(c.vie.vie0);
    SDL_FreeSurface(d.vie.vie1);
    SDL_FreeSurface(d.vie.vie2);
    SDL_FreeSurface(d.vie.vie3);
    SDL_FreeSurface(d.vie.vie0);
    SDL_FreeSurface(c.score.fondScore);
    SDL_FreeSurface(d.score.fondScore);
    SDL_FreeSurface(c.score.texteScore);
    SDL_FreeSurface(d.score.texteScore);
